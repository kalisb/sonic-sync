...
public class libtorrent implements libtorrentConstants {
  ...
  public static void set_final(SWIGTYPE_p_torrent_removed_alert value) {
    libtorrent_jni._final_set(SWIGTYPE_p_torrent_removed_alert.getCPtr(value));
  }

  public static SWIGTYPE_p_torrent_removed_alert get_final() {
    return new SWIGTYPE_p_torrent_removed_alert(libtorrent_jni._final_get(), true);
  }
